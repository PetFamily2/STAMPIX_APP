...
describe('wipeAllDataHardImpl', () => {
  test('wipes all tables and returns detailed delete stats', async () => {
    const tables = {
      ...
      redemptionCelebrationReceipts: [
        { _id: 'rcr_1', ownerUserId: 'u_admin', businessId: 'b_1' },
      ],
      smartManagerRecipientOutcomes: [
        { _id: 'smro_1', userId: 'u_admin', businessId: 'b_1' },
      ],
      smartManagerOutcomeDirtyMarkers: [
        { _id: 'smod_1', userId: 'u_admin', businessId: 'b_1' },
      ],
      smartManagerOutcomeReversalMarkers: [
        { _id: 'smor_1', userId: 'u_admin', businessId: 'b_1' },
      ],
      campaignRunRecipients: [
        { _id: 'crr_1', businessId: 'b_1', campaignRunId: 'cr_1' },
      ],
      smartManagerMigrations: [
      ...
      campaignRuns: [{ _id: 'cr_1', businessId: 'b_1' }],
    ...
    const expectedCounts = {
      ...
      smartManagerOutcomeDirtyMarkers: 1,
      smartManagerOutcomeReversalMarkers: 1,
      campaignRunRecipients: 1,
