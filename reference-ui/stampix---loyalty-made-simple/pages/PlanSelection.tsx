    ...
    <div className="flex-1 flex flex-col p-6 animate-in fade-in slide-in-from-bottom duration-500 bg-mint-bg">
        ...
        {plans.map((plan) => (
          ...
          >
            ...
            <div className="flex justify-between items-start mb-6 flex-row-reverse">
              ...
              <div
                className={`size-12 rounded-2xl flex items-center justify-center ${plan.id === 'starter' ? 'bg-gray-100 text-gray-400' : 'bg-blue-50 text-primary'}`}
              >
            ...
            <div className="space-y-3 mb-8">
              ...
              {plan.notIncluded.map((f, i) => (
                <div
                  key={i}
                  className="flex items-center gap-3 flex-row-reverse text-right opacity-40"
                >
      ...
      <footer className="py-6 text-center">
        <p className="text-[10px] text-gray-400 font-bold uppercase">
          ניתן לשנות מסלול בכל עת בהגדרות החשבון
        </p>
      </footer>
    </div>
  );
