    ...
    <div className="flex-1 flex flex-col relative bg-black overflow-hidden">
      ...
      <header className="relative z-20 p-6 flex justify-between items-center">
         ...
         <div className="bg-primary/20 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/10">
            <span className="text-white font-bold text-sm tracking-wide">סורק עסקים</span>
         </div>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center relative z-10 px-6">
         {status === 'scanning' && (
           <div className="text-center">
              ...
              <h3 className="text-white text-xl font-bold mb-2">סרוק את הקוד של העסק</h3>
              <p className="text-white/50 text-sm">הצטרף למועדון והתחל לצבור נקודות</p>
           </div>
         )}
         ...
         {status === 'success' && (
           <div className="w-full max-w-sm bg-white rounded-[2.5rem] p-8 flex flex-col items-center text-center shadow-2xl animate-in zoom-in duration-500">
              ...
              <h3 className="text-2xl font-black text-text-main mb-2">ברוך הבא ל"קפה ארומה"!</h3>
