  ...
  return (
    <div className="flex-1 flex flex-col bg-white overflow-hidden animate-in slide-in-from-left duration-300">
      <header className="p-6 flex items-center justify-between bg-white/80 backdrop-blur-md sticky top-0 z-20 border-b border-gray-50">
        <button onClick={onBack} className="p-2 bg-gray-50 rounded-full flex items-center justify-center">
        ...
        {step === 'payment' && (
          <div className="flex flex-col gap-6 animate-in slide-in-from-bottom duration-500">
            <div className="bg-blue-600 p-8 rounded-[2.5rem] text-white shadow-xl shadow-blue-600/20 flex flex-col items-center text-center">
               ...
               <p className="text-blue-100/80 text-sm mt-1">אתה במרחק נגיעה מלוח בקרה עוצמתי</p>
            ...
            <div className="flex flex-col gap-4 text-right">
               <h3 className="font-black text-text-main px-1 text-sm uppercase tracking-widest text-gray-400">פרטי כרטיס אשראי</h3>
               ...
               <div className="flex flex-col gap-2">
                  <div className="relative">
                    ...
                    />
                    <span className="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 text-gray-300">credit_card</span>
                  </div>
               </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-8 animate-in fade-in duration-500">
             <div className="relative size-32">
                ...
                <div className="absolute inset-4 bg-blue-50 rounded-full flex items-center justify-center">
                   <span className="material-symbols-outlined text-blue-600 text-4xl animate-pulse">account_balance</span>
                </div>
             </div>
             <div className="text-center">
                <h3 className="text-2xl font-black text-text-main mb-2">מעבד תשלום...</h3>
                <p className="text-gray-400">אנא המתן, אנחנו מאמתים את פרטי הכרטיס מול הבנק</p>
             </div>
          </div>
        )}
        ...
        {step === 'success' && (
          <div className="flex-1 flex flex-col items-center justify-center gap-8 animate-in zoom-in duration-500">
             ...
             <div className="text-center px-6">
                <h3 className="text-3xl font-black text-text-main mb-3">המנוי שודרג בהצלחה!</h3>
