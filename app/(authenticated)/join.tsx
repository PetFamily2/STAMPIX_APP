...
const TEXT = {
  ...
  subtitle: 'סרקו QR של העסק או הדביקו קוד ייחודי',
  manualTitle: 'אין QR? הדביקו קוד עסק',
  manualPlaceholder: 'קוד הצטרפות',
  join: 'הצטרף',
  checking: 'בודק',
  scanAgain: 'סרוק שוב',
  invalidCode: 'אנא הזן קוד עסק תקין',
  invalidQr: 'הקוד אינו תקין נסה שוב',
  businessNotFound: 'העסק לא נמצא בדוק את הקוד',
  programNotFound: 'אין תוכנית פעילה לעסק הזה',
  joinFailed: 'ההצטרפות נכשלה נסה שוב',
  unexpectedError: 'אירעה שגיאה לא צפויה נסה שוב',
  alreadyMember: 'אתה כבר חבר במועדון הזה נפתח את הכרטיסיה',
};
