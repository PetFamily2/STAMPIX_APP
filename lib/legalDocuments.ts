    ...
    sections: [
      {
        ...
        body: [
          ...
          'המחיקה מתחילה רק לאחר אישור מפורש. עד לאישור הסופי אפשר לחזור ולבטל את התהליך.',
        ],
        tone: 'warning',
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          'אם יש שאלה על מחיקה או זכויות מידע, אפשר לפנות דרך מסך העזרה והתמיכה באפליקציה.',
        ],
      },
    ],
  },
