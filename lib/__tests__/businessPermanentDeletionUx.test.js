...
describe('permanent business deletion UX', () => {
  ...
  test('Business Settings keeps reversible closure and adds a separate owner-only permanent action', () => {
    const source = readSource(BUSINESS_ACCOUNT_DATA);
  ...
  test('ordinary Account Details does not expose permanent deletion as a peer action', () => {
    const account = readSource(BUSINESS_ACCOUNT);
