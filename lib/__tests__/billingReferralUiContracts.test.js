...
describe('billing and referral UI contracts', () => {
  ...
  test('Home is the sole normal B2B entry and extra-business creation stays hidden', () => {
    ...
    expect(dashboard).toContain('<DashboardBusinessReferralCard');
    expect(campaigns).not.toContain('settings-business-invite-businesses');
