...
describe('rtl source-of-truth styles', () => {
  ...
  test('keeps known Android screenshot regressions anchored to RTL start', () => {
    ...
    expect(referralCard).toContain("alignSelf: 'flex-start'");
    ...
    expect(welcome).not.toContain('tw.itemsEnd');
  });
