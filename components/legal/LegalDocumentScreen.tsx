    ...
    sections: [
      {
        ...
        body: [
          ...
          'פעילות נאמנות: כרטיסיות, ניקובים, מימושים, סריקות QR, שיוך לעסק, קמפיינים והיסטוריית פעולות.',
      ...
      },
      {
        ...
        body: [
          'כדי להפעיל את החשבון, לאפשר צבירה ומימוש הטבות, להציג ארנק לקוח ולנהל עסקים, קמפיינים וצוותים.',
      ...
      },
      {
        ...
        body: [
          'מידע עשוי להימסר לספקי תשתית הנדרשים להפעלת המוצר, כולל Convex/Auth, התראות Expo, ספקי מפות ומיקום, RevenueCat כאשר תשלומים פעילים, ספקי אימייל וספקי ניטור ותמיכה.',
    ...
    sections: [
      {
        title: 'מהות השירות',
        body: [
          'STAMPAIX מספקת פלטפורמה דיגיטלית לנאמנות לקוחות, כרטיסיות, ניקובים, קמפיינים, סריקות QR וניהול צוותים.',
      ...
      },
      {
        ...
        body: [
          'כאשר מערכת התשלומים פעילה, מסלולים, מחירים, מחזורי חיוב והטבות יוצגו לפני רכישה. רכישות וניהול מנויים עשויים להתבצע דרך RevenueCat או חנויות האפליקציות.',
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'פעולות היסטוריות שקשורות לעסק, לקמפיין או למניעת הונאה עשויות להישמר בצורה מצומצמת או לא מזהה, כדי לא לפגוע בתקינות רשומות עסקיות.',
        ],
      },
      {
